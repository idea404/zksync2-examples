...
const tokenAddress = "0xef16000d668a6c5343a8b07bBEC8682C2AA4FdA4"; // Crown token which can be minted for free
const paymasterAddress = "0xc08aCd67c48818CaC2599Bfb585B411FFD5a0BF2"; // Paymaster for Crown token
...
async function main() {
    ...
    console.log(`Wallet balance before mint: ${await wallet.getBalance()}`);
    ...
    console.log(`Minting 3 Crown tokens for wallet...`);
    ...
    await mintTx.wait();
    console.log(`Minted 3 Crown tokens for wallet`);
